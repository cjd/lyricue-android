...
public class AvailableSongsAdapter extends ArrayAdapter<String> implements SectionIndexer {
	...
	public AvailableSongsAdapter(Context context, String[] main, String[] small, int[] ids) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.available_song_row, parent, false);
